 ...
 *Two ways to access STL string characters element: operand[] and iterator
 */
 #include <string>
 #include <iostream>
 ...
 int main()
 {
	...
	int charOffset = 0;
	string::const_iterator iCharacterLocator = strSTLString.begin();
	for( 
	...
	//Acess the contents of a string as a C-style string
